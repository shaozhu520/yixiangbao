<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buddhism.aspx.cs" Inherits="vip20170612.Buddhism" %>
...
<head runat="server">
    ...
    <title>楞严咒--星火传承</title>
    <link rel="stylesheet" href="css/base.css" />
    <link rel="stylesheet" href="css/index.css" />
    <link href="css/Buddhism.css" rel="stylesheet" />
    <script type="text/javascript" src="js/jquery-1.11.0.js"></script>
    <script type="text/javascript" src="js/Buddhism.js"></script>
        ...
        <div class="Content-Main">
            <div class="nav_s">
                <div class="nav_s-title">
                    <img src="img/sy.png" alt="" /><a href="index.aspx">首页</a> &gt; <a href="Buddhism.aspx">楞严咒</a>
                </div>
            </div>

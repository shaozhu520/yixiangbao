<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="activity.aspx.cs" Inherits="vip20170612.activity" %>
...
<meta charset="UTF-8" />
    ...
    <title>线报活动 - 易线报-不做大多数，别具一格。</title>
    <!--[if lt IE 9]>
...
<body>
    ...
    <div class="currentLocation  container">
        <div class="currentLocation-con row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">当前位置：<i class="icon-index layui-icon">&#xe68e;</i><span><a href="javascript:;">首页</a></span><span class="not-margin">-</span><span><a href="javascript:;">线报活动</a></span></div>
        </div>
    </div>
    <!--当前位置结束-->
        ...
        <div class="Articles-con row">
            <div class="Articles-con-l col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="Articles-con-l-title col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h2><i class="Articles-con-l-title-icon layui-icon">&#xe609;</i>线报活动</h2>
                </div>
    ...
    <script src="js/xiaobao_page.js" type="text/javascript" charset="utf-8"></script>

...
{
    public partial class HeadPortrait : System.Web.UI.Page
    {
        ...
        public string tjgethtml()//排行榜函数
        {
            ...
            try
            {
                List<RNews> listPh = RNewsDAL.m_RNewsDal.GetList("IsClass='唯美头像' and Auditing='true'", 10, 1, true, "ID,Title", "lrNumber");

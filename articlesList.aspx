<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="articlesList.aspx.cs" Inherits="vip20170612.articlesList" %>
...
<meta charset="UTF-8" />
    ...
    <title>教程软件 - 易线报-不做大多数，别具一格。</title>
    <!--[if lt IE 9]>
    ...
    <script src="js/articlesList.js" type="text/javascript" charset="utf-8"></script>
...
<body>
    ...
    <div class="currentLocation  container">
        <div class="currentLocation-con row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">当前位置：<i class="icon-index layui-icon">&#xe68e;</i><span><a href="javascript:;">首页</a></span><span class="not-margin">-</span><span><a href="javascript:;">教程软件</a></span></div>
        </div>
    </div>
    <!--当前位置结束-->
        ...
        <div class="Articles-con row">
            <div class="Articles-con-l col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="Articles-con-l-title col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h2><i class="Articles-con-l-title-icon layui-icon">&#xe609;</i>软件教程列表</h2>
                </div>
